...
### Rooster Contracts
 ...
 After succesful completion the WASM contract is generated. You can use the [polkadot.js exlorer](https://polkadot.js.org/apps/?rpc=ws%3A%2F%2F127.0.0.1%3A9944#/explorer) to deploy the contract manually and interact with it as [shown here](./Contract%20manual%20deploy.md)
